...
file = open('Text_Outputs/BBC1/BC_gensim/run2/bbc_gensin_50d_output_run2.txt', 'w')
file1= open('Text_Outputs/BBC1/BC_gensim/run2/bbc_gensin_50d_output_generation_details_run2.txt', 'w')
...
plt.savefig('Text_Outputs/BBC1/BC_gensim/run2/bbc_gensin_50d_run2.jpeg')
plt.show()
