...
file = open('Output_without_SOM1_new/nips_uci_full_paper/run1/nips_uci_full_paper_run1.txt', 'w')
file1 = open('Output_without_SOM1_new/nips_uci_full_paper/run1/nips_uci_full_paper_output_generation_details_run1.txt', 'w')
...
plt.savefig('Output_without_SOM1_new/nips_uci_full_paper/run1/nips_uci_full_paper_run1.jpeg')
plt.show()
